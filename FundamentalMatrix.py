...
class FundametanMatrix:
    def __init__(self):
        return

    def points_normalize(self, points1, points2):
        # validate points
    ...
    def CalcFundamentlMatrix(self, pts1, pts2):
        pts1, pts2, T1, T2 = self.points_normalize(pts1, pts2)
        pts1 = pts1.T
        pts2 = pts2.T
    ...
    def plot_line(self, coeffs, xlim):
        """
    ...
    def plot_epipolar_lines(self, img1, img2, points1, points2, show_epipole=False):
        """
        ...
        F = self.CalcFundamentlMatrix(points1, points2)
        ...
        if show_epipole:
            # compute epipole
            e1 = self.compute_epipole(F)
            e2 = self.compute_epipole(F.T)
            # plot epipole
